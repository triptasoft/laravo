...
namespace Triptasoft\Laravo\Charts;
...
class LaravoChart
{
    ...
    {
        return view('laravo::html', ['options' => $this->options]);
    }
    ...
    {
        return view('laravo::javascript', ['options' => $this->options, 'datasets' => $this->datasets]);
    }
