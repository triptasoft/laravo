        ...
        @if($db->action == 'create')
            <div class="col-md-3 col-sm-4 col-xs-6">
                ...
                <input type="checkbox" name="create_model" data-toggle="toggle"
                       data-on="{{ __('voyager::generic.yes_please') }}" data-off="{{ __('voyager::generic.no_thanks') }}" checked>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6">
                <label for="scope_owner">Create Owner Scope?</label><br>
                <input type="checkbox" name="scope_owner" data-toggle="toggle"
