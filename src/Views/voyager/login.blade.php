...
@section('content')
    <div class="login-container">
        ...
        <a class="btn login-button" style="background:white;color:grey;border:1px solid grey" href="{{ route('laravo.google.redirect') }}" role="button" style="text-transform:none">
